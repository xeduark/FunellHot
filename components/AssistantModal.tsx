...
const AssistantModal: React.FC<AssistantModalProps> = ({
  ...
  const onSubmit = (data: AssistantFormData) => {
    if (step !== 2) return; // ⛔ NO guardar antes
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200 border border-slate-200 dark:border-slate-800">
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-slate-900/50">
          ...
          <button
            ...
            className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 p-2 transition-colors"
          >
            ✕
          </button>
        </div>
              ...
              <div className="space-y-4 animate-in slide-in-from-right-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none bg-white dark:bg-slate-800 dark:text-white ${
                      errors.name
                        ? "border-red-500"
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      <span className="w-20 text-sm text-slate-500 dark:text-slate-400">
                        Cortas
                      </span>
                      <input
                        type="number"
                      ...
                      <div className="flex-1 bg-slate-100 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${responseLength.short}%` }}
                        />
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 bg-slate-100 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${responseLength.medium}%` }}
                        />
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 bg-slate-100 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${responseLength.long}%` }}
                        />
                      </div>
                    </div>
                  </div>
                  {!isValidSum && (
                    <p className="text-red-500 dark:text-red-400 text-xs mt-3 bg-red-50 dark:bg-red-950/30 p-2 rounded border border-red-100 dark:border-red-900/50 text-center">
                      La suma debe ser exactamente 100%. Actual:{" "}
